 ...
 */
	Configure::write('Security.salt', 'DYasdskjdfko4654567sdfdfddf32ssadDSer6');

/**
 * Random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '135465468721684645468888454588');
