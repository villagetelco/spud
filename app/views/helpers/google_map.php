...
class GoogleMapHelper extends Helper {
    ...
    var map;
         ...
         //var iconimage = \"img/icons/client.png\";
    ...
    if(isset($default['directions_div']))
        ...
        google.maps.event.addDomListener('marker','click', true);
    ...
    function drawLine($link,$zoom){
          ...
          $out = "
            ...
            //<![CDATA[
             ...
             var path = [
                 new google.maps.LatLng(".$link['lat1'].", ".$link['long1']."),new google.maps.LatLng(".$link['lat2'].", ".$link['long2']."),
                 ];
             polyline = new google.maps.Polyline({path:path, strokeColor: \"".$link['color']."\", strokeOpacity: 1.0, strokeWeight: 2});
             polyline.setMap(map);
